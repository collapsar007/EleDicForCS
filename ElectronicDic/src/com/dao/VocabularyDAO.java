...
public class VocabularyDAO {
	...
	public ArrayList<Vocabulary> search(String key) throws SQLException{
		ArrayList<Vocabulary> vacabulary =null;
		conn=connDB.getConnection();
		String sql = "SELECT * FROM t_vocabulary WHERE abbreviation LIKE '"+key
				+"%' or fullwords LIKE '"+key+"%' or fullwords LIKE '% "+key
				+"%' or specificmeaning LIKE '"+key+"%' ORDER BY priority DESC"; 
	...
	public int saveVocabulary(Vocabulary vocabulary) throws SQLException {
		...
		ps.setInt(5,1);//鏂版坊鍔犵殑浼樺厛绾ч粯璁や负1
